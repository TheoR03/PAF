...
def ABCDbis(imageName,mask):
    ...
    #similarToEllipse
    ret,thresh = cv2.threshold(mask,127,255,0)
    img,contours,hierarchy = cv2.findContours(thresh, 1, 2) #contours,hierarchy
    cnt = contours[0]
    ellipse = cv2.fitEllipse(cnt)
    ellipseMask=np.zeros((x,y))
    cv2.ellipse(ellipseMask,ellipse,255,-1)
...
for i in range(trainingSetLength):#previous version range(lenght)
    ...
    imageAddress='C:\\Users\\theor\\Downloads\\ISIC-2017_Training_Data\\ISIC-2017_Training_Data\\'+diagnostic[i,0]+'.jpg'
    maskAddress='C:\\Users\\theor\\Downloads\\Masks\\'+diagnostic[i,0]+'_segmentation.png'
...
def diagnostic(imageAddress,mask):
    features=ABCD(imageAddress,mask)
    diagnostics=[0,0,0,0]
...
address = 'C:\\Users\\theor\\Downloads\\Ground_truth_ISIC_1.xlsx'
#print(linearDiscriminantAnalysis(address,10))

print(diagnostic('C:\\Users\\theor\\Downloads\\ISIC-2017_Training_Data\\ISIC-2017_Training_Data\\ISIC_0009950.jpg','C:\\Users\\theor\\Downloads\\Masks\\ISIC_0009950_segmentation.png'))
